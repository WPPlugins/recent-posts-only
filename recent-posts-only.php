...
function recentpostsonly_network_new($blog_id) {
	// Registers settings when network activated and a new blog is created
...
add_action('wpmu_new_blog', 'recentpostsonly_network_new');
?>
